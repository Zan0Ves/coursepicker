...
## Käyttö ja asennus 
 ...
 - Tämän käyttöä varten sinulla pitää olla ladattuna python ja joku koodieditori.
     - voit käyttää mitä vain koodieditoria, mutta suosittelen [Sublime Textiä]([https://www.jetbrains.com/pycharm/download/?section=windows](https://github.com/Zan0Ves/coursepicker/blob/main/README.md)).
 ...
 - Uudessa versiossa helpotin huomattavasti koodin käyttämistä. Nyt sinun vain pitää kirjoittaa kurssien nimit niille tarkoitettuihin kohtiin. 
...
En ole vastuussa mistään koodin aiheuttamista haitoista. Olet itse vastuussa siitä miten sitä käytät.
